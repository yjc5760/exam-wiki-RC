...
* [RC-2015-1](problems/RC-2015-1.md) — 方形柱最大極限彎矩載重（設計峰值在拉力控制界限）
...
* [RC-2009-3](problems/RC-2009-3.md) — 壓拉桿模式 STM 深梁（θ=45°，斜壓桿控制 127.5 tf）
* [RC-2010-3](problems/RC-2010-3.md) — 軸力影響剪力開裂強度三種軸力比較
* [RC-2014-3](problems/RC-2014-3.md) — 軸力對 Vc 的規範三路徑（18.75／32.40／10.57 tf）
* [RC-2017-2](problems/RC-2017-2.md) — 加大柱介面剪力摩擦剪力法（195.7 tf、每側 17 支 D19）
* [RC-2020-2](problems/RC-2020-2.md) — 倒 T 型梁：載重在下翼板故不可 d 偏移（s=16.6 cm）
* [RC-2023-3](problems/RC-2023-3.md) — 懸臂梁臨界斷面扭力忽略門檻（Vu=7.425 tf、e=10.4 cm）
...
* [RC-2005-3](problems/RC-2005-3.md) — 角柱接頭：$V_{jh}=131.5$ tf $\le \phi V_n=163.8$ tf ✓（$1.25f_y$、$V_{col}=M_{pr}/H$；屋頂層則 112.6 tf 不通過）
* [RC-2009-1](problems/RC-2009-1.md) — 耐震柱橫向鋼筋密箍區 lo 圍束箍筋
* [RC-2010-2](problems/RC-2010-2.md) — 耐震柱縱向搭接 Class B 搭接拉力搭接
* [RC-2012-2](problems/RC-2012-2.md) — 耐震梁特殊矩形框架梁可能彎矩強度 Mpr
* [RC-2012-3](problems/RC-2012-3.md) — 柱塑鉸區：$V_u=25.17$ tf（接頭彎矩由上下柱分擔），4 腳#4 @9 cm、$l_o=60$ cm、區外 @13 cm
* [RC-2012-4](problems/RC-2012-4.md) — 梁柱外接頭接頭剪力角隅邊柱 Vjh
* [RC-2013-2](problems/RC-2013-2.md) — 16-D32 方形柱圍束：$s=12$ cm、外方箍+3 繫筋（5 腳 D13，$A_{sh}=6.35\ge6.31$）、區外 @15 cm
...
* [RC-2022-4](problems/RC-2022-4.md) — 橋柱三層韌性：$L_p=0.595$ m（下限控制）、$\mu_\phi=4.0$、$\mu_\theta=\mu=2.63$（需求讀法則 2.5／1.82）
* [RC-2025-2](problems/RC-2025-2.md) — 耐震梁剪力：$V_e=46.4$ tf、密箍區 4 腳 D13 @15 cm（152 cm）、一般區 2 腳 D13 @20 cm
